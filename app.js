...
const Store = {
  ...
  customers:  ['Muratec','Daifuku','ASML','Micron','UMC','Golden Foundries'],
  ...
  timesheets: [
    {
      ...
      entries:[
        { id:1,  date:'2026-05-04', customer:'ASML',    workHrs:8, sbHrs:0, sbType:'Standby', description:'EUV machine calibration',        country:'Netherlands', equipment:'EUV',      allowances:['Meal Allowance', 'Project Allowance'], ot15:0, ot20:0 },
        ...
        { id:3,  date:'2026-05-06', customer:'Daifuku', workHrs:8, sbHrs:0, sbType:'Standby', description:'SRC installation phase 1',          country:'Japan',       equipment:'SRC',      allowances:[], ot15:0, ot20:0 },
        { id:4,  date:'2026-05-07', customer:'ASML',    workHrs:6, sbHrs:2, sbType:'Standby', description:'On-call support',                   country:'Netherlands', equipment:'EUV',      allowances:[], ot15:0, ot20:0 },
    ...
    },
    {
      ...
      entries:[
        { id:8,  date:'2026-05-04', customer:'Daifuku', workHrs:8, sbHrs:0, sbType:'Standby', description:'Conveyor installation support',     country:'Japan',       equipment:'SRC',      allowances:['Project Allowance'], ot15:0, ot20:0 },
        ...
        { id:10, date:'2026-05-06', customer:'ASML',    workHrs:4, sbHrs:4, sbType:'Annual Leave', description:'Half-day leave, half-day EUV', country:'Netherlands', equipment:'EUV',      allowances:[], ot15:0, ot20:0 },
    ...
    },
    {
      ...
      entries:[
        { id:14, date:'2026-05-04', customer:'Daifuku', workHrs:8, sbHrs:0, sbType:'Standby', description:'SRC commissioning day 1',            country:'China',       equipment:'SRC',      allowances:['Transport Allowance', 'Project Allowance'], ot15:0, ot20:0 },
        { id:15, date:'2026-05-05', customer:'Daifuku', workHrs:4, sbHrs:4, sbType:'Medical', description:'Morning sick leave, afternoon work',  country:'China',       equipment:'SRC',      allowances:[], ot15:0, ot20:0 },
      ]
    }
  ],
  ...
  $('ts-modal-body').innerHTML = `
    ...
    <div class="table-scroll">
      <table class="apple-table">
        <thead><tr>
          <th>Date</th><th>Customer</th><th>Working</th><th>Standby/Leave</th><th>Description</th><th>Country</th><th>Equipment</th><th>Allowances</th><th>OT 1.5×</th><th>OT 2.0×</th>
...
function renderAnalytics(el) {
  el.innerHTML = `
    <div class="sec-header">
      <div class="sec-title"><h1>Analytics</h1><p>OT hours breakdown across teams, countries and customers</p></div>
